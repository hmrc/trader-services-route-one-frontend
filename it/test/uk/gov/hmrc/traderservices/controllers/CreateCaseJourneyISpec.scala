...
import test.uk.gov.hmrc.traderservices.stubs.{PdfGeneratorStubs, TraderServicesApiStubs, UpscanInitiateStubs}
import test.uk.gov.hmrc.traderservices.support
import test.uk.gov.hmrc.traderservices.support.{ServerISpec, StateMatchers, TestData, TestJourneyService}
...
trait CreateCaseJourneyISpecSetup extends ServerISpec with StateMatchers {
  ...
  lazy val journey = new support.TestJourneyService
    with CreateCaseJourneyService with EncryptedSessionCache[State, HeaderCarrier] {
