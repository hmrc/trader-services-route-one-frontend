...
class FormFieldMappingsSpec extends UnitSpec with FormMappingMatchers {
  ...
  "FormFieldMappings" should {
    ...
    "validate import contactNumberMapping" in {
      ...
      importContactNumberMapping.bind(Map("" -> "0Some(123456789)1a!")) should haveOnlyError(
        "error.contactNumber"
      )
    ...
    "validate export contactNumberMapping" in {
      ...
      exportContactNumberMapping.bind(Map("" -> "0Some(123456789)1a!")) should haveOnlyError(
        "error.contactNumber"
      )
