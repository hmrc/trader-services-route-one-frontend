...
researchBanner.heading=Helpwch i wella gwasanaethau CThEF
researchBanner.inviteLink=Helpwch i wella gwasanaethau digidol drwy ymuno â phanel defnyddwyr CThEF (yn agor ffenestr newydd)
...
view.upload-file.help.fileFormat3=e-bost (.txt)
...
error.file-upload.invalid-type=Mae’n rhaid i’r ffeil dan sylw fod ar ffurf .jpg, .png, .tiff, .pdf, .txt, Fformat Dogfen Agored (ODF), neu Microsoft Office
...
form.typeOfAmendment.WriteResponse=Ysgrifennu ymateb i gwestiwn y mae CThEF wedi’i ofyn
...
view.write-response-text.title=Ysgrifennu ymateb i ymholiad gan CThEF
view.write-response-text.heading=Ysgrifennu ymateb i ymholiad gan CThEF
...
error.responseText.required=Nodwch ymateb i ymholiad gan CThEF
