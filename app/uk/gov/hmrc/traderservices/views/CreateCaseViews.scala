...
class CreateCaseViews @Inject() (
  ...
  val entryDetailsEntryView: EntryDetailsEntryView,
  ...
  val exportQuestionsExplanationView: ExportQuestionsExplanationView,
  ...
  val importQuestionsExplanationView: ImportQuestionsExplanationView,
