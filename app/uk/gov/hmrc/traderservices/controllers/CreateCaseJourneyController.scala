      ...
      case CreateCaseConfirmation(
        ...
        Ok(
          views.createCaseConfirmationView(
            ...
            controller.downloadCreateCaseConfirmationReceiptAsPdf(s"Document_receipt_$caseReferenceId.pdf"),
            controller.showStart
          )
        )
      ...
      case CreateCaseConfirmation(
        ...
        printStylesheet.content.map(stylesheet =>
          Ok(
            ...
            HeaderNames.CONTENT_DISPOSITION -> s"""attachment; filename="Document_receipt_$caseReferenceId.html""""
          )
        )
    ...
    state match {
      case CreateCaseConfirmation(
        ...
        printStylesheet.content
          ...
          .flatMap(pdfGeneratorConnector.convertHtmlToPdf(_, s"Document_receipt_$caseReferenceId.pdf"))
